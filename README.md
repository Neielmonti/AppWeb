...
### Paso OPCIONAL: Entrenamiento de modelo
...
Para poder utilizar el modelo recien entrenado, debe insertar los archivos .keras y .json en la carpeta raiz del proyecto,
